...
Pod::Spec.new do |s|
  ...
  #
  # s.author       = { "Austin Grigg" => "austin@kaloncreative.com" }
  s.authors      = { "Chad Meyer" => "chadmeyer@me.com", "Austin Grigg" => "austin@kaloncreative.com" }

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/kaloncreative/FellowshipOneAPIClient.git", :commit => "a1f3bce185e2559d7769d81b18b7b26ae0ab36fa" }
